...
using .AWSCorePrototypeServices: redshift

"""
Describes properties of scheduled actions. 
"""
DescribeScheduledActions() = redshift("POST", "/")

"""
Deletes the specified snapshot copy grant.
"""
DeleteSnapshotCopyGrant(SnapshotCopyGrantName) = redshift("POST", "/")

"""
Revokes an ingress rule in an Amazon Redshift security group for a previously authorized IP range or Amazon EC2 security group. To add an ingress rule, see AuthorizeClusterSecurityGroupIngress. For information about managing security groups, go to Amazon Redshift Cluster Security Groups in the Amazon Redshift Cluster Management Guide. 
"""
RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName) = redshift("POST", "/")
...
"""
CreateClusterParameterGroup(ParameterGroupName, ParameterGroupFamily, Description) = redshift("POST", "/")

"""
Modifies the maintenance settings of a cluster.
"""
ModifyClusterMaintenance(ClusterIdentifier) = redshift("POST", "/")

"""
Returns a list of snapshot schedules. 
"""
DescribeSnapshotSchedules() = redshift("POST", "/")
...
"""
ModifyCluster(ClusterIdentifier) = redshift("POST", "/")
...
"""
DescribeClusterParameterGroups() = redshift("POST", "/")

"""
Creates a scheduled action. A scheduled action contains a schedule and an Amazon Redshift API action. For example, you can create a schedule of when to run the ResizeCluster API operation. 
"""
CreateScheduledAction(ScheduledActionName, TargetAction, Schedule, IamRole) = redshift("POST", "/")
...
"""
RestoreFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier) = redshift("POST", "/")
...
"""
CreateClusterSnapshot(SnapshotIdentifier, ClusterIdentifier) = redshift("POST", "/")

"""
Displays a list of event categories for all event source types, or for a specified source type. For a list of the event categories and source types, go to Amazon Redshift Event Notifications.
"""
DescribeEventCategories() = redshift("POST", "/")
...
"""
PurchaseReservedNodeOffering(ReservedNodeOfferingId) = redshift("POST", "/")
...
"""
RevokeSnapshotAccess(SnapshotIdentifier, AccountWithRestoreAccess) = redshift("POST", "/")
...
"""
DescribeClusterSecurityGroups() = redshift("POST", "/")
...
"""
DescribeReservedNodeOfferings() = redshift("POST", "/")
...
"""
DeleteCluster(ClusterIdentifier) = redshift("POST", "/")
...
"""
AuthorizeSnapshotAccess(SnapshotIdentifier, AccountWithRestoreAccess) = redshift("POST", "/")

"""
Cancels a resize operation for a cluster.
"""
CancelResize(ClusterIdentifier) = redshift("POST", "/")
...
"""
AuthorizeClusterSecurityGroupIngress(ClusterSecurityGroupName) = redshift("POST", "/")

"""
Deletes a scheduled action. 
"""
DeleteScheduledAction(ScheduledActionName) = redshift("POST", "/")

"""
Returns an array of DC2 ReservedNodeOfferings that matches the payment type, term, and usage price of the given DC1 reserved node.
"""
GetReservedNodeExchangeOfferings(ReservedNodeId) = redshift("POST", "/")

"""
Deletes an Amazon Redshift event notification subscription.
"""
DeleteEventSubscription(SubscriptionName) = redshift("POST", "/")
...
"""
CreateCluster(ClusterIdentifier, NodeType, MasterUsername, MasterUserPassword) = redshift("POST", "/")

"""
Sets one or more parameters of the specified parameter group to their default values and sets the source values of the parameters to "engine-default". To reset the entire parameter group specify the ResetAllParameters parameter. For parameter changes to take effect you must reboot any associated clusters. 
"""
ResetClusterParameterGroup(ParameterGroupName) = redshift("POST", "/")
...
"""
CreateSnapshotCopyGrant(SnapshotCopyGrantName) = redshift("POST", "/")

"""
Modifies an existing Amazon Redshift event notification subscription.
"""
ModifyEventSubscription(SubscriptionName) = redshift("POST", "/")
...
"""
CreateHsmClientCertificate(HsmClientCertificateIdentifier) = redshift("POST", "/")
...
"""
CreateEventSubscription(SubscriptionName, SnsTopicArn) = redshift("POST", "/")

"""
Returns properties of possible node configurations such as node type, number of nodes, and disk usage for the specified action type.
"""
DescribeNodeConfigurationOptions(ActionType) = redshift("POST", "/")

"""
Deletes the specified HSM client certificate.
"""
DeleteHsmClientCertificate(HsmClientCertificateIdentifier) = redshift("POST", "/")
...
"""
CopyClusterSnapshot(SourceSnapshotIdentifier, TargetSnapshotIdentifier) = redshift("POST", "/")

"""
Modifies a cluster subnet group to include the specified list of VPC subnets. The operation replaces the existing list of subnets with the new list of subnets.
"""
ModifyClusterSubnetGroup(ClusterSubnetGroupName, SubnetIds) = redshift("POST", "/")

"""
Modifies the database revision of a cluster. The database revision is a unique revision of the database running in a cluster.
"""
ModifyClusterDbRevision(ClusterIdentifier, RevisionTarget) = redshift("POST", "/")

"""
Modifies the settings for a set of cluster snapshots.
"""
BatchModifyClusterSnapshots(SnapshotIdentifierList) = redshift("POST", "/")

"""
Deletes tags from a resource. You must provide the ARN of the resource from which you want to delete the tag or tags.
"""
DeleteTags(ResourceName, TagKeys) = redshift("POST", "/")

"""
Returns a list of all the available maintenance tracks.
"""
DescribeClusterTracks() = redshift("POST", "/")
...
"""
CreateTags(ResourceName, Tags) = redshift("POST", "/")
...
"""
DescribeHsmClientCertificates() = redshift("POST", "/")
...
"""
GetClusterCredentials(DbUser, ClusterIdentifier) = redshift("POST", "/")
...
"""
DescribeClusterSubnetGroups() = redshift("POST", "/")

"""
Deletes a snapshot schedule.
"""
DeleteSnapshotSchedule(ScheduleIdentifier) = redshift("POST", "/")

"""
Deletes a set of cluster snapshots.
"""
BatchDeleteClusterSnapshots(Identifiers) = redshift("POST", "/")

"""
Deletes the specified Amazon Redshift HSM configuration.
"""
DeleteHsmConfiguration(HsmConfigurationIdentifier) = redshift("POST", "/")
...
"""
CreateClusterSubnetGroup(ClusterSubnetGroupName, Description, SubnetIds) = redshift("POST", "/")

"""
Exchanges a DC1 Reserved Node for a DC2 Reserved Node with no changes to the configuration (term, payment type, or number of nodes) and no additional costs. 
"""
AcceptReservedNodeExchange(ReservedNodeId, TargetReservedNodeOfferingId) = redshift("POST", "/")

"""
Lists the status of one or more table restore requests made using the RestoreTableFromClusterSnapshot API action. If you don't specify a value for the TableRestoreRequestId parameter, then DescribeTableRestoreStatus returns the status of all table restore requests ordered by the date and time of the request in ascending order. Otherwise DescribeTableRestoreStatus returns the status of the table specified by TableRestoreRequestId.
"""
DescribeTableRestoreStatus() = redshift("POST", "/")
...
"""
DescribeTags() = redshift("POST", "/")

"""
Deletes the specified cluster subnet group.
"""
DeleteClusterSubnetGroup(ClusterSubnetGroupName) = redshift("POST", "/")

"""
Modifies a scheduled action. 
"""
ModifyScheduledAction(ScheduledActionName) = redshift("POST", "/")
...
"""
CreateClusterSecurityGroup(ClusterSecurityGroupName, Description) = redshift("POST", "/")
...
"""
CreateHsmConfiguration(HsmConfigurationIdentifier, Description, HsmIpAddress, HsmPartitionName, HsmPartitionPassword, HsmServerPublicCertificate) = redshift("POST", "/")

"""
Reboots a cluster. This action is taken as soon as possible. It results in a momentary outage to the cluster, during which the cluster status is set to rebooting. A cluster event is created when the reboot is completed. Any pending cluster modifications (see ModifyCluster) are applied at this reboot. For more information about managing clusters, go to Amazon Redshift Clusters in the Amazon Redshift Cluster Management Guide. 
"""
RebootCluster(ClusterIdentifier) = redshift("POST", "/")
...
"""
DescribeHsmConfigurations() = redshift("POST", "/")

"""
Returns account level backups storage size and provisional storage.
"""
DescribeStorage() = redshift("POST", "/")
...
"""
DescribeSnapshotCopyGrants() = redshift("POST", "/")
...
"""
DeleteClusterSnapshot(SnapshotIdentifier) = redshift("POST", "/")
...
"""
DeleteClusterSecurityGroup(ClusterSecurityGroupName) = redshift("POST", "/")

"""
Enables the automatic copy of snapshots from one region to another region for a specified cluster.
"""
EnableSnapshotCopy(ClusterIdentifier, DestinationRegion) = redshift("POST", "/")

"""
Modifies a snapshot schedule. Any schedule associated with a cluster is modified asynchronously.
"""
ModifySnapshotSchedule(ScheduleIdentifier, ScheduleDefinitions) = redshift("POST", "/")

"""
Returns a detailed list of parameters contained within the specified Amazon Redshift parameter group. For each parameter the response includes information such as parameter name, description, data type, value, whether the parameter value is modifiable, and so on. You can specify source filter to retrieve parameters of only specific type. For example, to retrieve parameters that were modified by a user action such as from ModifyClusterParameterGroup, you can specify source equal to user.  For more information about parameters and parameter groups, go to Amazon Redshift Parameter Groups in the Amazon Redshift Cluster Management Guide.
"""
DescribeClusterParameters(ParameterGroupName) = redshift("POST", "/")
...
"""
DescribeClusters() = redshift("POST", "/")
...
"""
DescribeDefaultClusterParameters(ParameterGroupFamily) = redshift("POST", "/")
...
"""
DescribeResize(ClusterIdentifier) = redshift("POST", "/")
...
"""
DisableSnapshotCopy(ClusterIdentifier) = redshift("POST", "/")
...
"""
RestoreTableFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier, SourceDatabaseName, SourceTableName, NewTableName) = redshift("POST", "/")

"""
Returns a list of attributes attached to an account
"""
DescribeAccountAttributes() = redshift("POST", "/")

"""
Returns descriptions of the available Amazon Redshift cluster versions. You can call this operation even before creating any clusters to learn more about the Amazon Redshift versions. For more information about managing clusters, go to Amazon Redshift Clusters in the Amazon Redshift Cluster Management Guide.
"""
DescribeClusterVersions() = redshift("POST", "/")
...
"""
DescribeEventSubscriptions() = redshift("POST", "/")

"""
Returns an array of ClusterDbRevision objects.
"""
DescribeClusterDbRevisions() = redshift("POST", "/")

"""
Stops logging information, such as queries and connection attempts, for the specified Amazon Redshift cluster.
"""
DisableLogging(ClusterIdentifier) = redshift("POST", "/")

"""
Creates a snapshot schedule with the rate of every 12 hours.
"""
CreateSnapshotSchedule() = redshift("POST", "/")
...
"""
ModifyClusterParameterGroup(ParameterGroupName, Parameters) = redshift("POST", "/")

"""
Modifies the number of days to retain snapshots in the destination AWS Region after they are copied from the source AWS Region. By default, this operation only changes the retention period of copied automated snapshots. The retention periods for both new and existing copied automated snapshots are updated with the new retention period. You can set the manual option to change only the retention periods of copied manual snapshots. If you set this option, only newly copied manual snapshots have the new retention period. 
"""
ModifySnapshotCopyRetentionPeriod(ClusterIdentifier, RetentionPeriod) = redshift("POST", "/")

"""
Starts logging information, such as queries and connection attempts, for the specified Amazon Redshift cluster.
"""
EnableLogging(ClusterIdentifier, BucketName) = redshift("POST", "/")
...
"""
ResizeCluster(ClusterIdentifier, NumberOfNodes) = redshift("POST", "/")

"""
Returns the descriptions of the reserved nodes.
"""
DescribeReservedNodes() = redshift("POST", "/")
...
"""
DeleteClusterParameterGroup(ParameterGroupName) = redshift("POST", "/")

"""
Modifies a snapshot schedule for a cluster.
"""
ModifyClusterSnapshotSchedule(ClusterIdentifier) = redshift("POST", "/")

"""
Describes whether information, such as queries and connection attempts, is being logged for the specified Amazon Redshift cluster.
"""
DescribeLoggingStatus(ClusterIdentifier) = redshift("POST", "/")

"""
Rotates the encryption keys for a cluster.
"""
RotateEncryptionKey(ClusterIdentifier) = redshift("POST", "/")
end
