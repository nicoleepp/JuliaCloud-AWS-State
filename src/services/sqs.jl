...
using .AWSCorePrototypeServices: sqs
...
"""
ChangeMessageVisibility(QueueUrl, ReceiptHandle, VisibilityTimeout) = sqs("POST", "/")
...
"""
DeleteMessage(QueueUrl, ReceiptHandle) = sqs("POST", "/")
...
"""
RemovePermission(QueueUrl, Label) = sqs("POST", "/")
...
"""
SendMessage(QueueUrl, MessageBody) = sqs("POST", "/")
...
"""
ListQueueTags(QueueUrl) = sqs("POST", "/")
...
"""
CreateQueue(QueueName) = sqs("POST", "/")
...
"""
ReceiveMessage(QueueUrl) = sqs("POST", "/")
...
"""
GetQueueAttributes(QueueUrl) = sqs("POST", "/")
...
"""
TagQueue(QueueUrl, Tags) = sqs("POST", "/")
...
"""
UntagQueue(QueueUrl, TagKeys) = sqs("POST", "/")
...
"""
DeleteMessageBatch(QueueUrl, Entries) = sqs("POST", "/")
...
"""
SendMessageBatch(QueueUrl, Entries) = sqs("POST", "/")
...
"""
SetQueueAttributes(QueueUrl, Attributes) = sqs("POST", "/")
...
"""
AddPermission(QueueUrl, Label, AWSAccountIds, Actions) = sqs("POST", "/")
...
"""
ChangeMessageVisibilityBatch(QueueUrl, Entries) = sqs("POST", "/")
...
"""
ListDeadLetterSourceQueues(QueueUrl) = sqs("POST", "/")
...
"""
GetQueueUrl(QueueName) = sqs("POST", "/")
end
