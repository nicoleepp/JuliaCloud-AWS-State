...
using .AWSCorePrototypeServices: rds

"""
Amazon Relational Database Service (Amazon RDS) supports importing MySQL databases by using backup files. You can create a backup of your on-premises database, store it on Amazon Simple Storage Service (Amazon S3), and then restore the backup file onto a new Amazon RDS DB instance running MySQL. For more information, see Importing Data into an Amazon RDS MySQL DB Instance in the Amazon RDS User Guide. 
"""
RestoreDBInstanceFromS3(DBInstanceIdentifier, DBInstanceClass, Engine, SourceEngine, SourceEngineVersion, S3BucketName, S3IngestionRoleArn) = rds("POST", "/")

"""
Modifies the properties of an endpoint in an Amazon Aurora DB cluster.  This action only applies to Aurora DB clusters. 
"""
ModifyDBClusterEndpoint(DBClusterEndpointIdentifier) = rds("POST", "/")

"""
Describes all available options.
"""
DescribeOptionGroupOptions(EngineName) = rds("POST", "/")

"""
Returns a list of the available DB engines.
"""
DescribeDBEngineVersions() = rds("POST", "/")
...
"""
CreateCustomAvailabilityZone(CustomAvailabilityZoneName) = rds("POST", "/")
...
"""
DescribeDBProxies() = rds("POST", "/")

"""
You can call DescribeValidDBInstanceModifications to learn what modifications you can make to your DB instance. You can use this information when you call ModifyDBInstance. 
"""
DescribeValidDBInstanceModifications(DBInstanceIdentifier) = rds("POST", "/")
...
"""
DeleteGlobalCluster(GlobalClusterIdentifier) = rds("POST", "/")
...
"""
FailoverDBCluster(DBClusterIdentifier) = rds("POST", "/")
...
"""
StopDBCluster(DBClusterIdentifier) = rds("POST", "/")

"""
Creates a DBSnapshot. The source DBInstance must be in "available" state.
"""
CreateDBSnapshot(DBSnapshotIdentifier, DBInstanceIdentifier) = rds("POST", "/")

"""
Creates a new option group. You can create up to 20 option groups.
"""
CreateOptionGroup(OptionGroupName, EngineName, MajorEngineVersion, OptionGroupDescription) = rds("POST", "/")
...
"""
AddRoleToDBCluster(DBClusterIdentifier, RoleArn) = rds("POST", "/")
...
"""
ModifyDBSnapshotAttribute(DBSnapshotIdentifier, AttributeName) = rds("POST", "/")
...
"""
RestoreDBInstanceToPointInTime(TargetDBInstanceIdentifier) = rds("POST", "/")
...
"""
StopActivityStream(ResourceArn) = rds("POST", "/")

"""
Describes the available installation media for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
"""
DescribeInstallationMedia() = rds("POST", "/")
...
"""
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn) = rds("POST", "/")
...
"""
BacktrackDBCluster(DBClusterIdentifier, BacktrackTo) = rds("POST", "/")
...
"""
PromoteReadReplica(DBInstanceIdentifier) = rds("POST", "/")

"""
Displays a list of categories for all event source types, or, if specified, for a specified source type. You can see a list of the event categories and source types in the  Events topic in the Amazon RDS User Guide. 
"""
DescribeEventCategories() = rds("POST", "/")
...
"""
CreateDBClusterEndpoint(DBClusterIdentifier, DBClusterEndpointIdentifier, EndpointType) = rds("POST", "/")
...
"""
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier) = rds("POST", "/")

"""
Deletes an existing option group.
"""
DeleteOptionGroup(OptionGroupName) = rds("POST", "/")
...
"""
RestoreDBClusterFromSnapshot(DBClusterIdentifier, SnapshotIdentifier, Engine) = rds("POST", "/")
...
"""
DeleteDBCluster(DBClusterIdentifier) = rds("POST", "/")
...
"""
RestoreDBInstanceFromDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier) = rds("POST", "/")

"""
Copies the specified DB cluster parameter group.  This action only applies to Aurora DB clusters. 
"""
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription) = rds("POST", "/")

"""
Deletes an RDS event notification subscription.
"""
DeleteEventSubscription(SubscriptionName) = rds("POST", "/")
...
"""
CreateGlobalCluster() = rds("POST", "/")

"""
Modifies the parameters of a DB parameter group to the engine/system default value. To reset specific parameters, provide a list of the following: ParameterName and ApplyMethod. To reset the entire DB parameter group, specify the DBParameterGroup name and ResetAllParameters parameters. When resetting the entire group, dynamic parameters are updated immediately and static parameters are set to pending-reboot to take effect on the next DB instance restart or RebootDBInstance request. 
"""
ResetDBParameterGroup(DBParameterGroupName) = rds("POST", "/")

"""
Disassociates an AWS Identity and Access Management (IAM) role from a DB instance.
"""
RemoveRoleFromDBInstance(DBInstanceIdentifier, RoleArn, FeatureName) = rds("POST", "/")
...
"""
ModifyEventSubscription(SubscriptionName) = rds("POST", "/")
...
"""
DeleteDBClusterParameterGroup(DBClusterParameterGroupName) = rds("POST", "/")

"""
Returns a list of orderable DB instance options for the specified engine.
"""
DescribeOrderableDBInstanceOptions(Engine) = rds("POST", "/")
...
"""
DescribeDBClusterParameters(DBClusterParameterGroupName) = rds("POST", "/")

"""
 Returns a list of DBParameterGroup descriptions. If a DBParameterGroupName is specified, the list will contain only the description of the specified DB parameter group. 
"""
DescribeDBParameterGroups() = rds("POST", "/")

"""
Deletes automated backups based on the source instance's DbiResourceId value or the restorable instance's resource ID.
"""
DeleteDBInstanceAutomatedBackup(DbiResourceId) = rds("POST", "/")
...
"""
ModifyDBParameterGroup(DBParameterGroupName, Parameters) = rds("POST", "/")
...
"""
DescribeDBClusterBacktracks(DBClusterIdentifier) = rds("POST", "/")

"""
 Modify a setting for an Amazon Aurora global cluster. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. For more information on Amazon Aurora, see  What Is Amazon Aurora? in the Amazon Aurora User Guide.   This action only applies to Aurora DB clusters. 
"""
ModifyGlobalCluster() = rds("POST", "/")
...
"""
RegisterDBProxyTargets(DBProxyName) = rds("POST", "/")
...
"""
CreateEventSubscription(SubscriptionName, SnsTopicArn) = rds("POST", "/")
...
"""
CreateDBCluster(DBClusterIdentifier, Engine) = rds("POST", "/")

"""
Creates a new DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the AWS Region.
"""
CreateDBSubnetGroup(DBSubnetGroupName, DBSubnetGroupDescription, SubnetIds) = rds("POST", "/")

"""
Removes a source identifier from an existing RDS event notification subscription.
"""
RemoveSourceIdentifierFromSubscription(SubscriptionName, SourceIdentifier) = rds("POST", "/")

"""
Imports the installation media for a DB engine that requires an on-premises customer provided license, such as SQL Server.
"""
ImportInstallationMedia(CustomAvailabilityZoneId, Engine, EngineVersion, EngineInstallationMediaPath, OSInstallationMediaPath) = rds("POST", "/")

"""
Returns information about endpoints for an Amazon Aurora DB cluster.  This action only applies to Aurora DB clusters. 
"""
DescribeDBClusterEndpoints() = rds("POST", "/")

"""
Revokes ingress from a DBSecurityGroup for previously authorized IP ranges or EC2 or VPC Security Groups. Required parameters for this API are one of CIDRIP, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId).
"""
RevokeDBSecurityGroupIngress(DBSecurityGroupName) = rds("POST", "/")

"""
Copies the specified DB parameter group.
"""
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupIdentifier, TargetDBParameterGroupDescription) = rds("POST", "/")
...
"""
AuthorizeDBSecurityGroupIngress(DBSecurityGroupName) = rds("POST", "/")
...
"""
StopDBInstance(DBInstanceIdentifier) = rds("POST", "/")

"""
Deletes the installation medium for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
"""
DeleteInstallationMedia(InstallationMediaId) = rds("POST", "/")
...
"""
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameters) = rds("POST", "/")

"""
Returns information about DB snapshots. This API action supports pagination.
"""
DescribeDBSnapshots() = rds("POST", "/")
...
"""
DeleteCustomAvailabilityZone(CustomAvailabilityZoneId) = rds("POST", "/")
...
"""
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier) = rds("POST", "/")

"""
Returns information about reserved DB instances for this account, or about a specified reserved DB instance.
"""
DescribeReservedDBInstances() = rds("POST", "/")
...
"""
CreateDBInstanceReadReplica(DBInstanceIdentifier, SourceDBInstanceIdentifier) = rds("POST", "/")
...
"""
ListTagsForResource(ResourceName) = rds("POST", "/")

"""
Promotes a Read Replica DB cluster to a standalone DB cluster.  This action only applies to Aurora DB clusters. 
"""
PromoteReadReplicaDBCluster(DBClusterIdentifier) = rds("POST", "/")

"""
Lists available reserved DB instance offerings.
"""
DescribeReservedDBInstancesOfferings() = rds("POST", "/")

"""
Returns the detailed parameter list for a particular DB parameter group.
"""
DescribeDBParameters(DBParameterGroupName) = rds("POST", "/")
...
"""
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier) = rds("POST", "/")
...
"""
StartActivityStream(ResourceArn, Mode, KmsKeyId) = rds("POST", "/")
...
"""
CreateDBSecurityGroup(DBSecurityGroupName, DBSecurityGroupDescription) = rds("POST", "/")
...
"""
DeregisterDBProxyTargets(DBProxyName) = rds("POST", "/")

"""
Returns a list of DB log files for the DB instance.
"""
DescribeDBLogFiles(DBInstanceIdentifier) = rds("POST", "/")
...
"""
DescribeDBProxyTargetGroups(DBProxyName) = rds("POST", "/")

"""
Displays backups for both current and deleted instances. For example, use this operation to find details about automated backups for previously deleted instances. Current instances with retention periods greater than zero (0) are returned for both the DescribeDBInstanceAutomatedBackups and DescribeDBInstances operations. All parameters are optional.
"""
DescribeDBInstanceAutomatedBackups() = rds("POST", "/")

"""
Describes the available option groups.
"""
DescribeOptionGroups() = rds("POST", "/")
...
"""
RemoveFromGlobalCluster() = rds("POST", "/")
...
"""
ModifyDBClusterSnapshotAttribute(DBClusterSnapshotIdentifier, AttributeName) = rds("POST", "/")
...
"""
DescribeGlobalClusters() = rds("POST", "/")
...
"""
AddTagsToResource(ResourceName, Tags) = rds("POST", "/")
...
"""
AddRoleToDBInstance(DBInstanceIdentifier, RoleArn, FeatureName) = rds("POST", "/")

"""
Deletes a DB security group.  The specified DB security group must not be associated with any DB instances. 
"""
DeleteDBSecurityGroup(DBSecurityGroupName) = rds("POST", "/")
...
"""
CreateDBClusterSnapshot(DBClusterSnapshotIdentifier, DBClusterIdentifier) = rds("POST", "/")
...
"""
RemoveTagsFromResource(ResourceName, TagKeys) = rds("POST", "/")
...
"""
StartDBInstance(DBInstanceIdentifier) = rds("POST", "/")
...
"""
DescribeDBProxyTargets(DBProxyName) = rds("POST", "/")
...
"""
RebootDBInstance(DBInstanceIdentifier) = rds("POST", "/")

"""
Returns a list of the source AWS Regions where the current AWS Region can create a Read Replica or copy a DB snapshot from. This API action supports pagination.
"""
DescribeSourceRegions() = rds("POST", "/")
...
"""
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier) = rds("POST", "/")
...
"""
DescribeDBSnapshotAttributes(DBSnapshotIdentifier) = rds("POST", "/")

"""
Returns a list of DBSubnetGroup descriptions. If a DBSubnetGroupName is specified, the list will contain only the descriptions of the specified DBSubnetGroup. For an overview of CIDR ranges, go to the Wikipedia Tutorial. 
"""
DescribeDBSubnetGroups() = rds("POST", "/")

"""
Modifies an existing option group.
"""
ModifyOptionGroup(OptionGroupName) = rds("POST", "/")

"""
Creates a new DB instance.
"""
CreateDBInstance(DBInstanceIdentifier, DBInstanceClass, Engine) = rds("POST", "/")
...
"""
ModifyCertificates() = rds("POST", "/")

"""
Applies a pending maintenance action to a resource (for example, to a DB instance).
"""
ApplyPendingMaintenanceAction(ResourceIdentifier, ApplyAction, OptInType) = rds("POST", "/")

"""
Modifies an existing DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the AWS Region.
"""
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIds) = rds("POST", "/")
...
"""
CopyDBSnapshot(SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier) = rds("POST", "/")

"""
Deletes a DB subnet group.  The specified database subnet group must not be associated with any DB instances. 
"""
DeleteDBSubnetGroup(DBSubnetGroupName) = rds("POST", "/")
...
"""
DeleteDBSnapshot(DBSnapshotIdentifier) = rds("POST", "/")
...
"""
ModifyDBProxyTargetGroup(TargetGroupName, DBProxyName) = rds("POST", "/")

"""
Returns events related to DB instances, DB security groups, DB snapshots, and DB parameter groups for the past 14 days. Events specific to a particular DB instance, DB security group, database snapshot, or DB parameter group can be obtained by providing the name as a parameter. By default, the past hour of events are returned.
"""
DescribeEvents() = rds("POST", "/")

"""
Returns the default engine and system parameter information for the specified database engine.
"""
DescribeEngineDefaultParameters(DBParameterGroupFamily) = rds("POST", "/")
...
"""
DescribeAccountAttributes() = rds("POST", "/")
...
"""
CreateDBParameterGroup(DBParameterGroupName, DBParameterGroupFamily, Description) = rds("POST", "/")

"""
Purchases a reserved DB instance offering.
"""
PurchaseReservedDBInstancesOffering(ReservedDBInstancesOfferingId) = rds("POST", "/")

"""
 Returns a list of DBSecurityGroup descriptions. If a DBSecurityGroupName is specified, the list will contain only the descriptions of the specified DB security group. 
"""
DescribeDBSecurityGroups() = rds("POST", "/")

"""
Lists all the subscription descriptions for a customer account. The description for a subscription includes SubscriptionName, SNSTopicARN, CustomerID, SourceType, SourceID, CreationTime, and Status. If you specify a SubscriptionName, lists the description for that subscription.
"""
DescribeEventSubscriptions() = rds("POST", "/")

"""
Modifies settings for a DB instance. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. To learn what modifications you can make to your DB instance, call DescribeValidDBInstanceModifications before you call ModifyDBInstance. 
"""
ModifyDBInstance(DBInstanceIdentifier) = rds("POST", "/")
...
"""
StartDBCluster(DBClusterIdentifier) = rds("POST", "/")
...
"""
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily) = rds("POST", "/")
...
"""
ResetDBClusterParameterGroup(DBClusterParameterGroupName) = rds("POST", "/")
...
"""
ModifyDBProxy(DBProxyName) = rds("POST", "/")
...
"""
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description) = rds("POST", "/")
...
"""
RestoreDBClusterFromS3(DBClusterIdentifier, Engine, MasterUsername, MasterUserPassword, SourceEngine, SourceEngineVersion, S3BucketName, S3IngestionRoleArn) = rds("POST", "/")

"""
Adds a source identifier to an existing RDS event notification subscription.
"""
AddSourceIdentifierToSubscription(SubscriptionName, SourceIdentifier) = rds("POST", "/")
...
"""
CreateDBProxy(DBProxyName, EngineFamily, Auth, RoleArn, VpcSubnetIds) = rds("POST", "/")

"""
Deletes a specified DB parameter group. The DB parameter group to be deleted can't be associated with any DB instances.
"""
DeleteDBParameterGroup(DBParameterGroupName) = rds("POST", "/")
...
"""
DeleteDBProxy(DBProxyName) = rds("POST", "/")

"""
Lists the set of CA certificates provided by Amazon RDS for this AWS account.
"""
DescribeCertificates() = rds("POST", "/")
...
"""
ModifyCurrentDBClusterCapacity(DBClusterIdentifier) = rds("POST", "/")
...
"""
DescribeDBClusterSnapshots() = rds("POST", "/")

"""
Copies the specified option group.
"""
CopyOptionGroup(SourceOptionGroupIdentifier, TargetOptionGroupIdentifier, TargetOptionGroupDescription) = rds("POST", "/")
...
"""
DescribeCustomAvailabilityZones() = rds("POST", "/")
...
"""
DescribeDBClusterParameterGroups() = rds("POST", "/")

"""
Downloads all or a portion of the specified log file, up to 1 MB in size.
"""
DownloadDBLogFilePortion(DBInstanceIdentifier, LogFileName) = rds("POST", "/")

"""
Returns a list of resources (for example, DB instances) that have at least one pending maintenance action.
"""
DescribePendingMaintenanceActions() = rds("POST", "/")
end
