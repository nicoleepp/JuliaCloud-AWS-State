...
using .AWSCorePrototypeServices: iam
...
"""
CreateServiceLinkedRole(AWSServiceName) = iam("POST", "/")
...
"""
UpdateRoleDescription(RoleName, Description) = iam("POST", "/")

"""
Enables the specified MFA device and associates it with the specified IAM user. When enabled, the MFA device is required for every subsequent login by the IAM user associated with the device.
"""
EnableMFADevice(UserName, SerialNumber, AuthenticationCode1, AuthenticationCode2) = iam("POST", "/")

"""
Lists the account alias associated with the AWS account (Note: you can have only one). For information about using an AWS account alias, see Using an Alias for Your AWS Account ID in the IAM User Guide.
"""
ListAccountAliases() = iam("POST", "/")

"""
Deletes the specified IAM group. The group must not contain any users or have any attached policies.
"""
DeleteGroup(GroupName) = iam("POST", "/")

"""
Retrieves information about when the specified access key was last used. The information includes the date and time of last use, along with the AWS service and Region that were specified in the last request made with that key.
"""
GetAccessKeyLastUsed(AccessKeyId) = iam("POST", "/")

"""
 Returns a list of IAM users that are in the specified IAM group. You can paginate the results using the MaxItems and Marker parameters.
"""
GetGroup(GroupName) = iam("POST", "/")
...
"""
GetGroupPolicy(GroupName, PolicyName) = iam("POST", "/")
...
"""
UpdateOpenIDConnectProviderThumbprint(OpenIDConnectProviderArn, ThumbprintList) = iam("POST", "/")
...
"""
GetAccountAuthorizationDetails() = iam("POST", "/")

"""
 Retrieves information about the specified instance profile, including the instance profile's path, GUID, ARN, and role. For more information about instance profiles, see About Instance Profiles in the IAM User Guide.
"""
GetInstanceProfile(InstanceProfileName) = iam("POST", "/")
...
"""
DetachUserPolicy(UserName, PolicyArn) = iam("POST", "/")
...
"""
ListInstanceProfilesForRole(RoleName) = iam("POST", "/")
...
"""
UpdateAccountPasswordPolicy() = iam("POST", "/")
...
"""
CreatePolicyVersion(PolicyArn, PolicyDocument) = iam("POST", "/")
...
"""
ListAttachedRolePolicies(RoleName) = iam("POST", "/")
...
"""
UpdateAccessKey(AccessKeyId, Status) = iam("POST", "/")
...
"""
CreateVirtualMFADevice(VirtualMFADeviceName) = iam("POST", "/")

"""
 Generates a credential report for the AWS account. For more information about the credential report, see Getting Credential Reports in the IAM User Guide.
"""
GenerateCredentialReport() = iam("POST", "/")

"""
Returns information about the specified OpenID Connect (OIDC) provider resource object in IAM.
"""
GetOpenIDConnectProvider(OpenIDConnectProviderArn) = iam("POST", "/")

"""
Lists information about the IAM OpenID Connect (OIDC) provider resource objects defined in the AWS account.
"""
ListOpenIDConnectProviders() = iam("POST", "/")

"""
Removes the specified user from the specified group.
"""
RemoveUserFromGroup(GroupName, UserName) = iam("POST", "/")
...
"""
PutUserPolicy(UserName, PolicyName, PolicyDocument) = iam("POST", "/")
...
"""
UntagRole(RoleName, TagKeys) = iam("POST", "/")
...
"""
ListAttachedGroupPolicies(GroupName) = iam("POST", "/")
...
"""
ListSigningCertificates() = iam("POST", "/")
...
"""
DeleteRolePolicy(RoleName, PolicyName) = iam("POST", "/")
...
"""
DeleteUserPolicy(UserName, PolicyName) = iam("POST", "/")
...
"""
AttachRolePolicy(RoleName, PolicyArn) = iam("POST", "/")
...
"""
UpdateLoginProfile(UserName) = iam("POST", "/")
...
"""
UploadSigningCertificate(CertificateBody) = iam("POST", "/")
...
"""
GetSSHPublicKey(UserName, SSHPublicKeyId, Encoding) = iam("POST", "/")
...
"""
ListSSHPublicKeys() = iam("POST", "/")

"""
Retrieves the password policy for the AWS account. For more information about using a password policy, go to Managing an IAM Password Policy.
"""
GetAccountPasswordPolicy() = iam("POST", "/")
...
"""
GetUserPolicy(UserName, PolicyName) = iam("POST", "/")

"""
 Deletes the specified AWS account alias. For information about using an AWS account alias, see Using an Alias for Your AWS Account ID in the IAM User Guide.
"""
DeleteAccountAlias(AccountAlias) = iam("POST", "/")
...
"""
ChangePassword(OldPassword, NewPassword) = iam("POST", "/")
...
"""
ListVirtualMFADevices() = iam("POST", "/")

"""
Resets the password for a service-specific credential. The new password is AWS generated and cryptographically strong. It cannot be configured by the user. Resetting the password immediately invalidates the previous password associated with this user.
"""
ResetServiceSpecificCredential(ServiceSpecificCredentialId) = iam("POST", "/")
...
"""
GetLoginProfile(UserName) = iam("POST", "/")
...
"""
DetachRolePolicy(RoleName, PolicyArn) = iam("POST", "/")
...
"""
DeletePolicy(PolicyArn) = iam("POST", "/")
...
"""
GetPolicyVersion(PolicyArn, VersionId) = iam("POST", "/")
...
"""
TagUser(UserName, Tags) = iam("POST", "/")
...
"""
UpdateServerCertificate(ServerCertificateName) = iam("POST", "/")
...
"""
GetContextKeysForPrincipalPolicy(PolicySourceArn) = iam("POST", "/")
...
"""
CreateRole(RoleName, AssumeRolePolicyDocument) = iam("POST", "/")
...
"""
DeleteInstanceProfile(InstanceProfileName) = iam("POST", "/")
...
"""
ListRoleTags(RoleName) = iam("POST", "/")
...
"""
ListServerCertificates() = iam("POST", "/")
...
"""
DetachGroupPolicy(GroupName, PolicyArn) = iam("POST", "/")
...
"""
CreateGroup(GroupName) = iam("POST", "/")
...
"""
TagRole(RoleName, Tags) = iam("POST", "/")
...
"""
UploadSSHPublicKey(UserName, SSHPublicKeyBody) = iam("POST", "/")
...
"""
DeleteVirtualMFADevice(SerialNumber) = iam("POST", "/")
...
"""
DeactivateMFADevice(UserName, SerialNumber) = iam("POST", "/")
...
"""
GetServiceLastAccessedDetailsWithEntities(JobId, ServiceNamespace) = iam("POST", "/")
...
"""
CreateServiceSpecificCredential(UserName, ServiceName) = iam("POST", "/")
...
"""
DeleteOpenIDConnectProvider(OpenIDConnectProviderArn) = iam("POST", "/")
...
"""
DeleteLoginProfile(UserName) = iam("POST", "/")
...
"""
SimulateCustomPolicy(PolicyInputList, ActionNames) = iam("POST", "/")
...
"""
UploadServerCertificate(ServerCertificateName, CertificateBody, PrivateKey) = iam("POST", "/")
...
"""
GetServiceLinkedRoleDeletionStatus(DeletionTaskId) = iam("POST", "/")
...
"""
ListAttachedUserPolicies(UserName) = iam("POST", "/")
...
"""
DeletePolicyVersion(PolicyArn, VersionId) = iam("POST", "/")
...
"""
AttachUserPolicy(UserName, PolicyArn) = iam("POST", "/")
...
"""
GetRolePolicy(RoleName, PolicyName) = iam("POST", "/")
...
"""
GetServiceLastAccessedDetails(JobId) = iam("POST", "/")
...
"""
UpdateSSHPublicKey(UserName, SSHPublicKeyId, Status) = iam("POST", "/")
...
"""
CreateOpenIDConnectProvider(Url, ThumbprintList) = iam("POST", "/")
...
"""
ListPoliciesGrantingServiceAccess(Arn, ServiceNamespaces) = iam("POST", "/")
...
"""
DeleteServerCertificate(ServerCertificateName) = iam("POST", "/")
...
"""
DeleteServiceLinkedRole(RoleName) = iam("POST", "/")
...
"""
DeleteSigningCertificate(CertificateId) = iam("POST", "/")
...
"""
GetServerCertificate(ServerCertificateName) = iam("POST", "/")

"""
Updates the description or maximum session duration setting of a role.
"""
UpdateRole(RoleName) = iam("POST", "/")
...
"""
DeleteGroupPolicy(GroupName, PolicyName) = iam("POST", "/")
...
"""
AttachGroupPolicy(GroupName, PolicyArn) = iam("POST", "/")
...
"""
ListServiceSpecificCredentials() = iam("POST", "/")
...
"""
GetOrganizationsAccessReport(JobId) = iam("POST", "/")
...
"""
ListGroupsForUser(UserName) = iam("POST", "/")

"""
 Retrieves a credential report for the AWS account. For more information about the credential report, see Getting Credential Reports in the IAM User Guide.
"""
GetCredentialReport() = iam("POST", "/")
...
"""
ListUserPolicies(UserName) = iam("POST", "/")
...
"""
PutUserPermissionsBoundary(UserName, PermissionsBoundary) = iam("POST", "/")

"""
Deletes the specified service-specific credential.
"""
DeleteServiceSpecificCredential(ServiceSpecificCredentialId) = iam("POST", "/")
...
"""
SimulatePrincipalPolicy(PolicySourceArn, ActionNames) = iam("POST", "/")
...
"""
DeleteRolePermissionsBoundary(RoleName) = iam("POST", "/")
...
"""
CreateInstanceProfile(InstanceProfileName) = iam("POST", "/")
...
"""
DeleteAccessKey(AccessKeyId) = iam("POST", "/")
...
"""
GenerateServiceLastAccessedDetails(Arn) = iam("POST", "/")
...
"""
DeleteRole(RoleName) = iam("POST", "/")

"""
Deletes the password policy for the AWS account. There are no parameters.
"""
DeleteAccountPasswordPolicy() = iam("POST", "/")
...
"""
GetSAMLProvider(SAMLProviderArn) = iam("POST", "/")
...
"""
ListGroupPolicies(GroupName) = iam("POST", "/")
...
"""
CreatePolicy(PolicyName, PolicyDocument) = iam("POST", "/")
...
"""
SetSecurityTokenServicePreferences(GlobalEndpointTokenVersion) = iam("POST", "/")
...
"""
ResyncMFADevice(UserName, SerialNumber, AuthenticationCode1, AuthenticationCode2) = iam("POST", "/")
...
"""
PutRolePolicy(RoleName, PolicyName, PolicyDocument) = iam("POST", "/")
...
"""
DeleteSSHPublicKey(UserName, SSHPublicKeyId) = iam("POST", "/")
...
"""
DeleteUserPermissionsBoundary(UserName) = iam("POST", "/")

"""
Creates an alias for your AWS account. For information about using an AWS account alias, see Using an Alias for Your AWS Account ID in the IAM User Guide.
"""
CreateAccountAlias(AccountAlias) = iam("POST", "/")
...
"""
ListPolicyVersions(PolicyArn) = iam("POST", "/")
...
"""
PutGroupPolicy(GroupName, PolicyName, PolicyDocument) = iam("POST", "/")
...
"""
ListRolePolicies(RoleName) = iam("POST", "/")
...
"""
ListEntitiesForPolicy(PolicyArn) = iam("POST", "/")
...
"""
AddRoleToInstanceProfile(InstanceProfileName, RoleName) = iam("POST", "/")
...
"""
DeleteSAMLProvider(SAMLProviderArn) = iam("POST", "/")
...
"""
SetDefaultPolicyVersion(PolicyArn, VersionId) = iam("POST", "/")
...
"""
AddClientIDToOpenIDConnectProvider(OpenIDConnectProviderArn, ClientID) = iam("POST", "/")

"""
Sets the status of a service-specific credential to Active or Inactive. Service-specific credentials that are inactive cannot be used for authentication to the service. This operation can be used to disable a user's service-specific credential as part of a credential rotation work flow.
"""
UpdateServiceSpecificCredential(ServiceSpecificCredentialId, Status) = iam("POST", "/")
...
"""
UpdateSigningCertificate(CertificateId, Status) = iam("POST", "/")
...
"""
CreateSAMLProvider(SAMLMetadataDocument, Name) = iam("POST", "/")
...
"""
GetPolicy(PolicyArn) = iam("POST", "/")

"""
Updates the policy that grants an IAM entity permission to assume a role. This is typically referred to as the "role trust policy". For more information about roles, go to Using Roles to Delegate Permissions and Federate Identities.
"""
UpdateAssumeRolePolicy(RoleName, PolicyDocument) = iam("POST", "/")
...
"""
PutRolePermissionsBoundary(RoleName, PermissionsBoundary) = iam("POST", "/")
...
"""
GetContextKeysForCustomPolicy(PolicyInputList) = iam("POST", "/")
...
"""
RemoveRoleFromInstanceProfile(InstanceProfileName, RoleName) = iam("POST", "/")

"""
Adds the specified user to the specified group.
"""
AddUserToGroup(GroupName, UserName) = iam("POST", "/")
...
"""
RemoveClientIDFromOpenIDConnectProvider(OpenIDConnectProviderArn, ClientID) = iam("POST", "/")
...
"""
UpdateGroup(GroupName) = iam("POST", "/")
...
"""
UntagUser(UserName, TagKeys) = iam("POST", "/")
end
