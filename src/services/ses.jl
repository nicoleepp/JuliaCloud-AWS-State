...
using .AWSCorePrototypeServices: ses
...
"""
ReorderReceiptRuleSet(RuleSetName, RuleNames) = ses("POST", "/")
...
"""
SendRawEmail(RawMessage) = ses("POST", "/")
...
"""
DeleteReceiptRule(RuleSetName, RuleName) = ses("POST", "/")
...
"""
CreateTemplate(Template) = ses("POST", "/")
...
"""
CreateCustomVerificationEmailTemplate(TemplateName, FromEmailAddress, TemplateSubject, TemplateContent, SuccessRedirectionURL, FailureRedirectionURL) = ses("POST", "/")
...
"""
CreateReceiptFilter(Filter) = ses("POST", "/")
...
"""
CreateConfigurationSet(ConfigurationSet) = ses("POST", "/")
...
"""
PutIdentityPolicy(Identity, PolicyName, Policy) = ses("POST", "/")
...
"""
GetIdentityDkimAttributes(Identities) = ses("POST", "/")
...
"""
GetIdentityVerificationAttributes(Identities) = ses("POST", "/")
...
"""
ListConfigurationSets() = ses("POST", "/")
...
"""
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination) = ses("POST", "/")
...
"""
GetIdentityMailFromDomainAttributes(Identities) = ses("POST", "/")
...
"""
SendTemplatedEmail(Source, Destination, Template, TemplateData) = ses("POST", "/")

"""
Deprecated. Use the VerifyEmailIdentity operation to verify a new email address.
"""
VerifyEmailAddress(EmailAddress) = ses("POST", "/")
...
"""
VerifyDomainDkim(Domain) = ses("POST", "/")
...
"""
CreateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions) = ses("POST", "/")
...
"""
ListIdentityPolicies(Identity) = ses("POST", "/")

"""
Modifies an association between a configuration set and a custom domain for open and click event tracking.  By default, images and links used for tracking open and click events are hosted on domains operated by Amazon SES. You can configure a subdomain of your own to handle these events. For information about using custom domains, see the Amazon SES Developer Guide.
"""
UpdateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions) = ses("POST", "/")
...
"""
CreateReceiptRuleSet(RuleSetName) = ses("POST", "/")
...
"""
DeleteConfigurationSet(ConfigurationSetName) = ses("POST", "/")
...
"""
SetActiveReceiptRuleSet() = ses("POST", "/")
...
"""
SetIdentityNotificationTopic(Identity, NotificationType) = ses("POST", "/")
...
"""
DescribeReceiptRule(RuleSetName, RuleName) = ses("POST", "/")
...
"""
UpdateTemplate(Template) = ses("POST", "/")
...
"""
DeleteReceiptRuleSet(RuleSetName) = ses("POST", "/")

"""
Adds or updates the delivery options for a configuration set.
"""
PutConfigurationSetDeliveryOptions(ConfigurationSetName) = ses("POST", "/")
...
"""
VerifyDomainIdentity(Domain) = ses("POST", "/")
...
"""
UpdateConfigurationSetReputationMetricsEnabled(ConfigurationSetName, Enabled) = ses("POST", "/")
...
"""
CloneReceiptRuleSet(RuleSetName, OriginalRuleSetName) = ses("POST", "/")
...
"""
SendCustomVerificationEmail(EmailAddress, TemplateName) = ses("POST", "/")
...
"""
UpdateConfigurationSetSendingEnabled(ConfigurationSetName, Enabled) = ses("POST", "/")
...
"""
DeleteReceiptFilter(FilterName) = ses("POST", "/")
...
"""
DeleteConfigurationSetTrackingOptions(ConfigurationSetName) = ses("POST", "/")

"""
Deprecated. Use the ListIdentities operation to list the email addresses and domains associated with your account.
"""
ListVerifiedEmailAddresses() = ses("POST", "/")
...
"""
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination) = ses("POST", "/")
...
"""
GetIdentityPolicies(Identity, PolicyNames) = ses("POST", "/")
...
"""
CreateReceiptRule(RuleSetName, Rule) = ses("POST", "/")
...
"""
SetIdentityMailFromDomain(Identity) = ses("POST", "/")
...
"""
VerifyEmailIdentity(EmailAddress) = ses("POST", "/")

"""
Deprecated. Use the DeleteIdentity operation to delete email addresses and domains.
"""
DeleteVerifiedEmailAddress(EmailAddress) = ses("POST", "/")

"""
Deletes an email template. You can execute this operation no more than once per second.
"""
DeleteTemplate(TemplateName) = ses("POST", "/")
...
"""
UpdateCustomVerificationEmailTemplate(TemplateName) = ses("POST", "/")
...
"""
SetIdentityFeedbackForwardingEnabled(Identity, ForwardingEnabled) = ses("POST", "/")
...
"""
TestRenderTemplate(TemplateName, TemplateData) = ses("POST", "/")
...
"""
DescribeActiveReceiptRuleSet() = ses("POST", "/")
...
"""
SendBounce(OriginalMessageId, BounceSender, BouncedRecipientInfoList) = ses("POST", "/")
...
"""
SendBulkTemplatedEmail(Source, Template, Destinations) = ses("POST", "/")
...
"""
DeleteCustomVerificationEmailTemplate(TemplateName) = ses("POST", "/")
...
"""
GetCustomVerificationEmailTemplate(TemplateName) = ses("POST", "/")
...
"""
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName) = ses("POST", "/")
...
"""
GetIdentityNotificationAttributes(Identities) = ses("POST", "/")
...
"""
GetAccountSendingEnabled() = ses("POST", "/")
...
"""
SendEmail(Source, Destination, Message) = ses("POST", "/")
...
"""
DescribeReceiptRuleSet(RuleSetName) = ses("POST", "/")
...
"""
UpdateReceiptRule(RuleSetName, Rule) = ses("POST", "/")
...
"""
DeleteIdentity(Identity) = ses("POST", "/")
...
"""
DescribeConfigurationSet(ConfigurationSetName) = ses("POST", "/")
...
"""
GetTemplate(TemplateName) = ses("POST", "/")
...
"""
SetIdentityHeadersInNotificationsEnabled(Identity, NotificationType, Enabled) = ses("POST", "/")
...
"""
SetIdentityDkimEnabled(Identity, DkimEnabled) = ses("POST", "/")
...
"""
ListCustomVerificationEmailTemplates() = ses("POST", "/")
...
"""
DeleteIdentityPolicy(Identity, PolicyName) = ses("POST", "/")
...
"""
SetReceiptRulePosition(RuleSetName, RuleName) = ses("POST", "/")
end
