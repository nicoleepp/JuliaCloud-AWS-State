...
using .AWSCorePrototypeServices: cloudwatch

"""
Displays the tags associated with a CloudWatch resource. Alarms support tagging.
"""
ListTagsForResource(ResourceARN) = cloudwatch("POST", "/")
...
"""
GetMetricStatistics(Namespace, MetricName, StartTime, EndTime, Period) = cloudwatch("POST", "/")
...
"""
SetAlarmState(AlarmName, StateValue, StateReason) = cloudwatch("POST", "/")

"""
Retrieves the specified alarms. If no alarms are specified, all alarms are returned. Alarms can be retrieved by using only a prefix for the alarm name, the alarm state, or a prefix for any action.
"""
DescribeAlarms() = cloudwatch("POST", "/")

"""
Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.
"""
EnableInsightRules(RuleNames) = cloudwatch("POST", "/")
...
"""
DescribeAlarmHistory() = cloudwatch("POST", "/")
...
"""
PutMetricAlarm(AlarmName, EvaluationPeriods, ComparisonOperator) = cloudwatch("POST", "/")
...
"""
PutAnomalyDetector(Namespace, MetricName, Stat) = cloudwatch("POST", "/")

"""
Enables the actions for the specified alarms.
"""
EnableAlarmActions(AlarmNames) = cloudwatch("POST", "/")
...
"""
PutInsightRule(RuleName, RuleDefinition) = cloudwatch("POST", "/")
...
"""
GetMetricWidgetImage(MetricWidget) = cloudwatch("POST", "/")
...
"""
TagResource(ResourceARN, Tags) = cloudwatch("POST", "/")

"""
Lists the anomaly detection models that you have created in your account. You can list all models in your account or filter the results to only the models that are related to a certain namespace, metric name, or metric dimension.
"""
DescribeAnomalyDetectors() = cloudwatch("POST", "/")

"""
Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do not incur costs.
"""
DisableInsightRules(RuleNames) = cloudwatch("POST", "/")

"""
Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
"""
DeleteDashboards(DashboardNames) = cloudwatch("POST", "/")

"""
Removes one or more tags from the specified resource.
"""
UntagResource(ResourceARN, TagKeys) = cloudwatch("POST", "/")

"""
Disables the actions for the specified alarms. When an alarm's actions are disabled, the alarm actions do not execute when the alarm state changes.
"""
DisableAlarmActions(AlarmNames) = cloudwatch("POST", "/")
...
"""
GetDashboard(DashboardName) = cloudwatch("POST", "/")
...
"""
PutDashboard(DashboardName, DashboardBody) = cloudwatch("POST", "/")
...
"""
DescribeInsightRules() = cloudwatch("POST", "/")
...
"""
ListDashboards() = cloudwatch("POST", "/")
...
"""
GetInsightRuleReport(RuleName, StartTime, EndTime, Period) = cloudwatch("POST", "/")
...
"""
DeleteAlarms(AlarmNames) = cloudwatch("POST", "/")

"""
Deletes the specified anomaly detection model from your account.
"""
DeleteAnomalyDetector(Namespace, MetricName, Stat) = cloudwatch("POST", "/")
...
"""
GetMetricData(MetricDataQueries, StartTime, EndTime) = cloudwatch("POST", "/")
...
"""
DeleteInsightRules(RuleNames) = cloudwatch("POST", "/")

"""
Retrieves the alarms for the specified metric. To filter the results, specify a statistic, period, or unit.
"""
DescribeAlarmsForMetric(MetricName, Namespace) = cloudwatch("POST", "/")
...
"""
PutMetricData(Namespace, MetricData) = cloudwatch("POST", "/")
end
